...
{
    public class PasswordForgotWorker<TUser> : BaseCrocoWorker where TUser : IdentityUser, new()
    {
        public PasswordForgotWorker(ICrocoAmbientContext context) : base(context)
        {
        }
